...
import { KeyRound, Plus, Search, X, Eye, EyeOff, Trash2, ShieldCheck, Copy, Check, Download, FileSpreadsheet, FileText } from "lucide-react";
...
export default function Credentials() {
  ...
  const handleSave = (form) => {
    const created = store.addCredential(form);
